 ...
 * @ORM\Entity(repositoryClass="App\Repository\Utilisateurs\UtilisateursAdressesRepository")
 */
class UserAdresses
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Utilisateurs\User", inversedBy="adresses")
